// 애플리케이션 기본 설정
export const APP_NAME = 'dooray-ai';
export const APP_VERSION = '0.1.0';
export const APP_DESCRIPTION = 'AI-powered CLI tool for automated development workflow with Dooray! integration';

// 설정 파일 경로
export const CONFIG_DIR = '.dooray-ai';
